...
<head>
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/public/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
...
<body class="single">
    <div class="container-fluid fh5co_header_bg">
        <div class="container">
            <div class="row">
                <div class="col-10 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;<?= date("l, d-M-Y") ?></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                    ...
                    <!--<div class="d-inline-block text-center"><img src="public/images/country.png" alt="img" class="fh5co_country_width"/></div>-->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="index.php?controller=news&action=index">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="index.php?controller=contact&action=index">Contact <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
